...
namespace ecommerce.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,TotalAmount,CreatedAt,Status")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,TotalAmount,CreatedAt,Status")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
